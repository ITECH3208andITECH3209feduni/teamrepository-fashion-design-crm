  <?php 
                            ...
                            $arr[] = !empty($result->p_front_thumb)?imgThumb('/web_uploads/product/thumb/','500x500',$result->p_front_thumb):'';
                            $arr[] = !empty($result->p_back_thumb)?imgThumb('/web_uploads/product/thumb/','500x500',$result->p_back_thumb):'';

                                        if(!empty($result->p_gallery)){
                                            $exp = explode('{+}',$result->p_gallery);
                                           
                                            if(!empty($exp))
                                            {
                                                foreach ($exp as $key => $img) {
                                                    $arr[] = !empty($img)?imgThumb('/web_uploads/product/items/','500x500',$img):'';
                                                }
                                            }
                                        }
...
<img src="<?=imgThumb('/web_uploads/product/thumb/','500x500',$result->p_front_thumb)?>" alt="">
</div>
<div class="features-caption">
<h3><?=$row->p_name?></h3>
<p><?=$row->cat_name?></p>
<div class="price">
<span>$<?=$row->p_sell?></span>
</div>
<div class="review">
<div class="rating">
...
<a href="javascript:;" data-add-cart="<?=$row->p_id?>?>" data-url-settings="<?=APP_URL?>cart/addcomparelist" class="white-btn mr-10">Add to Cart</a>
